...
public class Light2D : LightingMonoBehaviour {
	...
	public LightingSourceTransform transform2D;
	...
	public void OnEnable() {
		...
		if (transform2D == null) {
			transform2D = new LightingSourceTransform();
		}
	...
	private void OnDrawGizmos() {
		if (Lighting2D.ProjectSettings.sceneView.drawGizmos == EditorDrawGizmos.Disabled) {
			return;
		}
