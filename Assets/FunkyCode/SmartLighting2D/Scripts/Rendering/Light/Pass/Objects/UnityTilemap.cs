    ...
    public class UnityTilemap {
        ...
        static public void Sprite(Light2D light, LightTilemapCollider2D id, Material material, LayerSetting layerSetting) {
            ...
            for(int i = 0; i < count; i++) {
                ...
                Color color = LayerSettingColor.Get(tilePosition, layerSetting, MaskEffect.Lit);
                ...
                Universal.Sprite.FullRect.Simple.Draw(tile.spriteMeshObject, material, virtualSpriteRenderer, tilePosition, scale * tile.scale, rotation);
            }
