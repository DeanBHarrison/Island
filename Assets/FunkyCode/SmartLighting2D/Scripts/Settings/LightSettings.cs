...
namespace LightSettings {
	...
	public enum LightLayerSorting {None, DistanceToLight, YDistanceToLight, YAxisLower, YAxisHigher, ZAxisLower, ZAxisHigher};
	public enum LightLayerSortingIgnore {None, IgnoreAbove};

	public enum LightLayerShadowEffect {Default, Projected, SoftObjects, SoftVertex};
