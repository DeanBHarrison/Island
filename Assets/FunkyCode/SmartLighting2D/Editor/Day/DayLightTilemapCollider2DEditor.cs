    ...
    override public void OnInspectorGUI() {
        ...
        switch(script.tilemapType) {
			case MapType.UnityRectangle:
				script.rectangle.shadowType = (LightingTilemapCollider.ShadowType)EditorGUILayout.EnumPopup("Shadow Type", script.rectangle.shadowType);
				
				EditorGUI.BeginDisabledGroup(script.rectangle.shadowType == LightingTilemapCollider.ShadowType.None);
				...
				script.rectangle.maskType = (LightingTilemapCollider.MaskType)EditorGUILayout.EnumPopup("Mask Type", script.rectangle.maskType);
				
				EditorGUI.BeginDisabledGroup(script.rectangle.maskType == LightingTilemapCollider.MaskType.None);
